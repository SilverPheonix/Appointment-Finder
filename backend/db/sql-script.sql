...
INSERT INTO `Appointment-Finder`.`Selected`(`s_option`,`s_appointment`,`s_user`) VALUES (1,1,'Emma');
INSERT INTO `Appointment-Finder`.`Selected`(`s_option`,`s_appointment`,`s_user`) VALUES (1,2,'Emma');
INSERT INTO `Appointment-Finder`.`Selected`(`s_option`,`s_appointment`,`s_user`) VALUES (1,2,'Marie');
INSERT INTO `Appointment-Finder`.`Selected`(`s_option`,`s_appointment`,`s_user`) VALUES (1,3,'Marie');
INSERT INTO `Appointment-Finder`.`Selected`(`s_option`,`s_appointment`,`s_user`) VALUES (1,1,'Marie');
INSERT INTO `Appointment-Finder`.`Selected`(`s_option`,`s_appointment`,`s_user`) VALUES (1,2,'Toni');
INSERT INTO `Appointment-Finder`.`Selected`(`s_option`,`s_appointment`,`s_user`) VALUES (1,4,'Toni');
INSERT INTO `Appointment-Finder`.`Selected`(`s_option`,`s_appointment`,`s_user`) VALUES (2,5,'Stefan');
INSERT INTO `Appointment-Finder`.`Selected`(`s_option`,`s_appointment`,`s_user`) VALUES (2,7,'Stefan');
INSERT INTO `Appointment-Finder`.`Selected`(`s_option`,`s_appointment`,`s_user`) VALUES (2,6,'Ava');
INSERT INTO `Appointment-Finder`.`Selected`(`s_option`,`s_appointment`,`s_user`) VALUES (2,5,'Norbert');
INSERT INTO `Appointment-Finder`.`Selected`(`s_option`,`s_appointment`,`s_user`) VALUES (2,7,'Norbert');
INSERT INTO `Appointment-Finder`.`Selected`(`s_option`,`s_appointment`,`s_user`) VALUES (3,8,'Fiona');
INSERT INTO `Appointment-Finder`.`Selected`(`s_option`,`s_appointment`,`s_user`) VALUES (3,9,'Fiona');
INSERT INTO `Appointment-Finder`.`Selected`(`s_option`,`s_appointment`,`s_user`) VALUES (3,11,'Fiona');
INSERT INTO `Appointment-Finder`.`Selected`(`s_option`,`s_appointment`,`s_user`) VALUES (3,11,'Karola');
INSERT INTO `Appointment-Finder`.`Selected`(`s_option`,`s_appointment`,`s_user`) VALUES (3,10,'Karola');
INSERT INTO `Appointment-Finder`.`Selected`(`s_option`,`s_appointment`,`s_user`) VALUES (3,9,'Karola');
